...
function Qna(props) {
  return (
    <div className=" overflow-y-auto" style={{ height: "955px" }}>
      {props.data.results &&
        props.data.results
          .sort((a, b) => {
          ...
          .map((e, key) => {
            return (
              <div className="question  mt-3" key={key}>
                <div className="w-2/3" style={{ height: "420px" }} >
                  <p className=" font-sans font-bold text-base text-gray-600">
                    Q: {e.question_body}
                  </p>
                  <div className="answer mt-2 flex">
                    <p className="font-sans font-bold text-base text-gray-600">
                      A:
                    </p>
                    <div>
                ...
                <div className="side text-gray-600 flex">
                  <p>
                    Helpful?
                    <a href="#" className="underline ml-2 mr-1">
                      Yes
